...
def get_results(name):
    ...
    # filtered to remove duplicate rows where one patient takes the same test multiple times on one day
    filtered_results = name_matches.drop_duplicates(subset=["PatientID", "MostRecentTestDate", "TestName"])
